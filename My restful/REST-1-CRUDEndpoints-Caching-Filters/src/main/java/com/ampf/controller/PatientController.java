...
public class PatientController {
    ...
    /**
     * http://localhost:8080/services/patients/all
     * @return
     */
    @Path("/all")
    @GET
    public List<Patient> getAllPatients(@Context UriInfo uriInfo, @Context SecurityContext context){
    ...
    /**
     * localhost:8080/services/patients/patient/mani
     * @param name
     * @return
     */
    ...
    @Path("/patient/{name}")
    @GET
    public Response getPatientPathParamDemo(@PathParam("name") String name){
        ...
        return Response.ok(Patient.builder().name(name).build()).build();
    }

    /**
     * localhost:8080/services/patients/queryPatient?patientName=santu
     * @param name
     * @param vendorName
     * @param cookeyName
     * @return
    ...
    /**
     * localhost:8080/services/patients/parseCookies
     * @param cookeyName
     * @param request
     * @param httpResponse
     * @return
